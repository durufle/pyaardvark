Overview
========
This package encapsulates the access for the Aardvark device. .
...
The code of the package is developed under :file:`pyaardvark` directory.
The requirements.txt file include all packages needed for development.
